...
<html>
<head>
	<title>MyGym | All Trainers</title>
	...
	<div class="wrapper">
		...
		<div class="content_wrapper">
			...
			<div class="left" style="background-image: url(images/bg1.jpg)">
				<div class="middle">
					<center><label style="color: white;"><h1>Gym and Fitness | All Trainers</h1></label></center>
					...
					<table border="2" align="center" width="714px" style="color:white; background-color: black; border-color: white;">
						...
						$sql = "SELECT trainer.t_id, trainer.t_name, trainer.t_mobile, exercises.e_name, exercises.e_time FROM trainer INNER JOIN exercises ON trainer.e_id = exercises.e_id";
