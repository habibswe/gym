...
<html>
<head>
	<title>MyGym | Delete Trainer</title>
	...
	<div class="wrapper">
		...
		<div class="content_wrapper">
			...
			<div class="left" style="background-image: url(images/bg1.jpg)">
				<div class="middle">
					<center><label style="color: white;"><h1>Gym and Fitness | Delete Trainer</h1></label></center>

					<form action="delete_trainer_done.php" method="post">

						<br><br><br><br><br><br><br><br>

						<input type="text" required = "required" placeholder="Please Enter Member ID"name="delete_trainer_id">

						<input type="submit" name="delete_member" value="Delete Trainer"><br><br>
					</form>

					<a href="members_button.php"><button>Back</button></a>
