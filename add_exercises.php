	...
	<div class="wrapper">
		...
		<div class="content_wrapper">
			...
			<div class="left" style="background-image: url(images/bg1.jpg)">
				<div class="middle">
					<form action="exercise_insert_data.php" method="post">
						<center><label style="color: white;"><h1>Gym and Fitness | Add Exercises</h1></label></center>

						<br><br><br>

						<center><label style="color:white; background-color: black;">Exercise ID</label></center>
						<select id="add_exercise_id" name="add_exercise_id">
						...
						<select id="add_exercise_name" name="add_exercise_name">
						  <option value="" selected>~~ Please choose an option ~~</option>
						...
						<select id="add_exercise_time" name="add_exercise_time">
						  <option value="" selected>~~ Please choose an option ~~</option>
						...
						<input type="submit" name="add_exercise" value="Add Exercise"><br><br>
					</form>

					<a href="exercises_button.php"><button type="submit">Back</button></a>
				</div>
			</div>
		</div>
