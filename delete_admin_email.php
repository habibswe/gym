...
<html>
<head>
	<title>MyGym | Delete Admin ID</title>
	...
	<div class="wrapper">
		...
		<div class="content_wrapper">
			...
			<div class="left" style="background-image: url(images/bg1.jpg)">
				<div class="middle">
					<center><label style="color: white;"><h1>Gym and Fitness | Delete Admin</h1></label></center>

					<form action="delete_admin.php" method="post">

						<br><br><br><br><br><br><br><br><br>

						<input type="text" required = "required" placeholder="Please Enter Admin E-mail" id="delete_admin_email" name="delete_admin_email">

						<input type="submit" name="delete_email_admin" value="Delete Admin"><br><br>
					</form>
