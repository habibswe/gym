...
<html>
<head>
	<title>MyGym | Update Trainer Information</title>
	...
	<div class="wrapper">
		...
		<div class="content_wrapper">
			...
			<div class="left" style="background-image: url(images/bg1.jpg)">
				<div class="middle">
					<form action="update_trainer_done.php" method="post">
						<center><label style="color: white;"><h1>Gym and Fitness | Update Trainer</h1></label></center>

						<br><br><br>

						<center><label style="color:white; background-color: black;">ID</label></center>
						<input type="text" required = "required" placeholder="ID" name="up_trainer_id">

						<center><label style="color:white; background-color: black;">Name</label></center>
						<input type="text" required = "required" placeholder="New ID" name="up_trainer_name">

						<center><label style="color:white; background-color: black;">Exercise ID</label></center>
						<select id="up_trainer_exercise_id" name="up_trainer_exercise_id">
						...
						<input type="text" required = "required" placeholder="01XXXXXXXXX" id="up_member_mobile" name="up_trainer_mobile">

						<br><br>

						<input type="submit" name="update_trainer" value="Update Trainer"><br><br>
					</form>
				</div>
			</div>
		</div>
