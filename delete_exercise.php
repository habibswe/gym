...
<html>
<head>
	<title>MyGym | Delete Exercise</title>
	...
	<div class="wrapper">
		...
		<div class="content_wrapper">
			...
			<div class="left" style="background-image: url(images/bg1.jpg)">
				<div class="middle">
					<center><label style="color: white;"><h1>Gym and Fitness | Delete Exercise</h1></label></center>

					<form action="delete_exercise_done.php" method="post">

						<br><br><br><br><br><br><br><br>

						<input type="text" required = "required" placeholder="Please Enter Exercise ID"name="delete_exercise_id">

						<input type="submit" name="delete_member" value="Delete Trainer"><br><br>
					</form>

					<a href="exercises_button.php"><button>Back</button></a>
