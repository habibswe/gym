		...
		<div class="content_wrapper">
			...
			<div class="left" style="background-image: url(images/bg1.jpg)">
				<div class="middle">
					...
					<center><label style="color: white;"><h1>Gym and Fitness | Trainers</h1></label></center>

					<br><br><br>

					<a href="view_all_trainers.php"><button>View all Trainers</button></a>
					<a href="search_trainer.php"><button>Search Trainers</button></a>
					<a href="add_trainer.php"><button>Add Trainers</button></a>
					<a href="update_trainer_info.php"><button>Update Trainers Information</button></a>
					<a href="delete_trainer.php"><button>Delete Trainer</button></a>
