		...
		<div class="content_wrapper">
			...
			<div class="left" style="background-image: url(images/bg1.jpg)">
				<div class="middle">
					...
					<form action="view_search_exercise.php" method="post">

						<br>

						<input type="text" required = "required" placeholder="Please Enter Exercise ID" name="search_exercise_id">

						<input type="submit" value="Search Exercise"><br><br>
					</form>
