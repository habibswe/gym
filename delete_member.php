...
<html>
<head>
	<title>MyGym | Delete Member</title>
	...
	<div class="wrapper">
		...
		<div class="content_wrapper">
			...
			<div class="left" style="background-image: url(images/bg1.jpg)">
				<div class="middle">
					<center><label style="color: white;"><h1>Gym and Fitness | Delete Member</h1></label></center>

					<form action="delete_member_done.php" method="post">

						<br><br><br><br><br><br><br><br>

						<input type="text" required = "required" placeholder="Please Enter Member ID"name="delete_member_id">

						<input type="submit" name="delete_member" value="Delete Member"><br><br>
					</form>
